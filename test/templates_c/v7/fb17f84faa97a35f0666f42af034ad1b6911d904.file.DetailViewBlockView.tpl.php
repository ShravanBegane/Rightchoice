<?php /* Smarty version Smarty-3.1.7, created on 2020-01-07 08:55:00
         compiled from "/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10350348575c8b9dfa677939-96231539%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fb17f84faa97a35f0666f42af034ad1b6911d904' => 
    array (
      0 => '/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewBlockView.tpl',
      1 => 1578375670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10350348575c8b9dfa677939-96231539',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5c8b9dfa6d67c',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5c8b9dfa6d67c')) {function content_5c8b9dfa6d67c($_smarty_tpl) {?>
...
?><?php $_smarty_tpl->tpl_vars['BLOCK'] = new Smarty_variable($_smarty_tpl->tpl_vars['BLOCK_LIST']->value[$_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value], null, 0);?><?php if ($_smarty_tpl->tpl_vars['BLOCK']->value==null||count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)<=0){?><?php continue 1?><?php }?><div class="block block_<?php echo $_smarty_tpl->tpl_vars['MODULE_NAME']->value;?>
_<?php echo $_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value;?>
"  <?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
 $block_id = <?php echo $_smarty_tpl->tpl_vars['BLOCK_LIST']->value[$_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value]->get('id');?>
;  if($_GET['tab_label'] == "Business Details"){    if($block_id == '126' || $block_id == '127' || $block_id == '128' || $block_id == '129'){  echo 'style="display:none;"' ;  } } elseif($_GET['tab_label'] == "Business Modules"){ if($block_id == '9' || $block_id == '125' || $block_id == '11' || $block_id == '12'){  echo 'style="display:none;"' ;  } } <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
