<?php /* Smarty version Smarty-3.1.7, created on 2020-01-08 10:24:34
         compiled from "/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/Sidebar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7709378485c8b9c671a7872-45347211%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '92194c620de4e2914b140b941e649b74f1e877f9' => 
    array (
      0 => '/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Settings/Vtiger/Sidebar.tpl',
      1 => 1578375670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7709378485c8b9c671a7872-45347211',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5c8b9c671e8fe',
  'variables' => 
  array (
    'USER_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_5c8b9c671e8fe')) {function content_5c8b9c671e8fe($_smarty_tpl) {?>
...
_accordion" class="app-nav" role="tab"><div class="app-settings-accordion"><div class="settingsgroup-accordion"><a data-toggle="collapse" data-parent="#accordion" class='collapsed <?php echo $_smarty_tpl->tpl_vars['BLOCK_NAME']->value;?>
' href="#<?php echo $_smarty_tpl->tpl_vars['BLOCK_NAME']->value;?>
...
?><?php $_smarty_tpl->tpl_vars['MENU'] = new Smarty_variable($_smarty_tpl->tpl_vars['MENUITEM']->value->get('name'), null, 0);?><?php $_smarty_tpl->tpl_vars['MENU_LABEL'] = new Smarty_variable($_smarty_tpl->tpl_vars['MENU']->value, null, 0);?><?php if ($_smarty_tpl->tpl_vars['MENU']->value=='LBL_EDIT_FIELDS'){?><?php $_smarty_tpl->tpl_vars['MENU_LABEL'] = new Smarty_variable('LBL_MODULE_CUSTOMIZATION', null, 0);?><?php }elseif($_smarty_tpl->tpl_vars['MENU']->value=='LBL_TAX_SETTINGS'){?><?php $_smarty_tpl->tpl_vars['MENU_LABEL'] = new Smarty_variable('LBL_TAX_MANAGEMENT', null, 0);?><?php }elseif($_smarty_tpl->tpl_vars['MENU']->value=='INVENTORYTERMSANDCONDITIONS'){?><?php $_smarty_tpl->tpl_vars['MENU_LABEL'] = new Smarty_variable('LBL_TERMS_AND_CONDITIONS', null, 0);?><?php }?><?php $_smarty_tpl->tpl_vars['MENU_URL'] = new Smarty_variable($_smarty_tpl->tpl_vars['MENUITEM']->value->getUrl(), null, 0);?><?php $_smarty_tpl->tpl_vars['USER_MODEL'] = new Smarty_variable(Users_Record_Model::getCurrentUserModel(), null, 0);?><?php if ($_smarty_tpl->tpl_vars['MENU']->value=='My Preferences'){?><li><a data-name="LBL_MAIL_SCANNER" href="index.php?parent=Settings&amp;module=MailConverter&amp;view=List&amp;block=4&amp;fieldid=23" class="menuItemLabel  ui-draggable ui-draggable-handle">Mail Converter<img id="23_menuItem" data-id="23" class="pinUnpinShortCut cursorPointer pull-right" data-actionurl="index.php?module=Vtiger&amp;parent=Settings&amp;action=Basic&amp;mode=updateFieldPinnedStatus&amp;fieldid=23" data-pintitle="pin" data-unpintitle="Unpin" data-pinimageurl="layouts/v7/skins/images/pin.png" data-unpinimageurl="layouts/v7/skins/images/unpin.png" title="pin" src="layouts/v7/skins/images/pin.png" data-action="pin"></a></li><li><a data-name="Mail" href="index.php?module=MailManager&view=List" class="menuItemLabel  ui-draggable ui-draggable-handle">Mail Settings</a></li><li><a data-name="Email Templates"  href="index.php?module=EmailTemplates&view=List&app=TOOLS" class="menuItemLabel  ui-draggable ui-draggable-handle">Email Templates</a></li><?php $_smarty_tpl->tpl_vars['MENU_URL'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->getPreferenceDetailViewUrl(), null, 0);?><?php }elseif($_smarty_tpl->tpl_vars['MENU']->value=='Calendar Settings'){?><?php $_smarty_tpl->tpl_vars['MENU_URL'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->getCalendarSettingsDetailViewUrl(), null, 0);?><?php }?><li><a data-name="<?php echo $_smarty_tpl->tpl_vars['MENU']->value;?>
...
" data-action="pin"<?php }?> /></a></li><?php } ?></ul></div></div><?php }?><?php } ?><!--<div class="settingsgroup-panel panel panel-default instaSearch"><div class="app-settings-accordion"><div class="settingsgroup-accordion"><a  href="index.php?module=Calendar&view=Export"><i class="indicator fa fa-chevron-right "></i>&nbsp;<span>Export</span><a  href="index.php?module=Leads&view=Import"><i class="indicator fa fa-chevron-right "></i>&nbsp;<span>Import</span></a></div></div></div>--></div></div><?php }else{ ?><?php echo $_smarty_tpl->getSubTemplate ('modules/Users/UsersSidebar.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
<?php }?>
<?php }} ?>