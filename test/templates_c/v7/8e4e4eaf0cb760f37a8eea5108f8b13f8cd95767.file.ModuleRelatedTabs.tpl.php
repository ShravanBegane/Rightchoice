<?php /* Smarty version Smarty-3.1.7, created on 2020-01-07 06:10:34
         compiled from "/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleRelatedTabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16901844725c8b9df7276e78-76935468%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8e4e4eaf0cb760f37a8eea5108f8b13f8cd95767' => 
    array (
      0 => '/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleRelatedTabs.tpl',
      1 => 1578375670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16901844725c8b9df7276e78-76935468',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5c8b9df72e314',
  'variables' => 
  array (
    'DETAILVIEW_LINKS' => 0,
    'RELATED_LINK' => 0,
...
<?php if ($_valid && !is_callable('content_5c8b9df72e314')) {function content_5c8b9df72e314($_smarty_tpl) {?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['RELATED_TAB_LABEL'] = new Smarty_variable((($_tmp1).(" ")).($_smarty_tpl->tpl_vars['RELATEDLINK_LABEL']->value), null, 0);?><li class="tab-item tab <?php if ($_smarty_tpl->tpl_vars['RELATED_TAB_LABEL']->value==$_smarty_tpl->tpl_vars['SELECTED_TAB_LABEL']->value){?>active<?php }?>" data-url="<?php echo $_smarty_tpl->tpl_vars['RELATEDLINK_URL']->value;?>
...
</span></span><?php }?>&nbsp;<span class="numberCircle hide">0</span></a></li><?php }} ?></ul></li><?php }?></ul></div><div class="col-md-12 col-lg-12 detailViewButtoncontainer"><div class="pull-right btn-toolbar"><div class="btn-group"><?php $_smarty_tpl->tpl_vars['STARRED'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD']->value->get('starred'), null, 0);?><!--<button class="btn btn-default addButton createActivity toDotask textOverflowEllipsis max-width-100" title="Add Activity" type="button" href="javascript:void(0)" data-url="sourceModule=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getModuleName();?>
&sourceRecord=<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getId();?>
&relationOperation=true" ><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Activity</button>--><?php if ($_smarty_tpl->tpl_vars['MODULE']->value!='Products'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Documents'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Assets'&&$_smarty_tpl->tpl_vars['MODULE']->value!='ServiceContracts'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Services'&&$_smarty_tpl->tpl_vars['MODULE']->value!='PriceBooks'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Vendors'&&$_smarty_tpl->tpl_vars['MODULE']->value!='ProjectTask'&&$_smarty_tpl->tpl_vars['MODULE']->value!='ProjectMilestone'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Visitors'&&$_smarty_tpl->tpl_vars['MODULE']->value!='Teams'){?><button class="btn btn-default addButton createActivity textOverflowEllipsis max-width-100" title="Add Activity" data-name="Activity" data-url="index.php?module=Events&view=QuickCreateAjax" href="javascript:void(0)" type="button"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add Activity</button><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isStarredEnabled()){?><button class="btn btn-default markStar <?php if ($_smarty_tpl->tpl_vars['STARRED']->value){?> active <?php }?>" id="starToggle" style="width:100px;"><div class='starredStatus' title="<?php echo vtranslate('LBL_STARRED',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
?><?php if ($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel()==''){?><li class="divider"></li><?php }else{ ?><li class="more_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['DETAIL_VIEW_LINK']->value->getLabel());?>
