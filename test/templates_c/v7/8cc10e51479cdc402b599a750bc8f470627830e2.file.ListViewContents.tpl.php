<?php /* Smarty version Smarty-3.1.7, created on 2020-01-07 06:10:12
         compiled from "/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7836631955c8b9df37493f2-60293672%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8cc10e51479cdc402b599a750bc8f470627830e2' => 
    array (
      0 => '/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl',
      1 => 1578375670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7836631955c8b9df37493f2-60293672',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5c8b9df37d580',
  'variables' => 
  array (
    'MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_5c8b9df37d580')) {function content_5c8b9df37d580($_smarty_tpl) {?>
...
<?php if ($_smarty_tpl->tpl_vars['MODULE']->value==='Support'){?>
<iframe src="support.php" width="100%" height="700px" style="margin-top: -14px;" frameborder="0"></iframe>
<style>
button#Support_listView_basicAction_LBL_ADD_RECORD 
{
    display: none;
}

button#Support_basicAction_LBL_IMPORT
{
	display:none;
}
.col-sm-12.col-xs-12 {
...
<?php }elseif($_smarty_tpl->tpl_vars['MODULE']->value==='Emailmarketing'){?>

<iframe src="email_marketing.php" width="100%" height="700px" style="margin-top: -14px;" frameborder="0"></iframe>
<style>
button#Emailmarketing_listView_basicAction_LBL_ADD_RECORD 
{
    display: none;
}

button#Emailmarketing_basicAction_LBL_IMPORT
{
	display:none;
}
...
"> <?php echo vtranslate('LBL_CREATE');?>
									...
									<?php }?>
                             						<?php }else{ ?>
									<a style="color:blue" href="index.php?module=Calendar&view=Edit&mode=Events&calendarModule=Events"> <?php echo vtranslate('LBL_CREATE');?>
</a>
									<?php if (Users_Privileges_Model::isPermitted($_smarty_tpl->tpl_vars['MODULE']->value,'Import')&&$_smarty_tpl->tpl_vars['LIST_VIEW_MODEL']->value->isImportEnabled()){?>
										<?php echo vtranslate('LBL_OR',$_smarty_tpl->tpl_vars['MODULE']->value);?>
