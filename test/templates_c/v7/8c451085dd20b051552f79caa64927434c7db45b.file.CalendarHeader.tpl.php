<?php /* Smarty version Smarty-3.1.7, created on 2019-03-12 21:35:17
         compiled from "/home/urldiary/my360crm.urldiary.com/includes/runtime/../../layouts/v7/modules/Calendar/CalendarHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3750193585c6e8a0784b2c2-05009285%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c451085dd20b051552f79caa64927434c7db45b' => 
    array (
      0 => '/home/urldiary/my360crm.urldiary.com/includes/runtime/../../layouts/v7/modules/Calendar/CalendarHeader.tpl',
      1 => 1552388636,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3750193585c6e8a0784b2c2-05009285',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5c6e8a0789a73',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5c6e8a0789a73')) {function content_5c6e8a0789a73($_smarty_tpl) {?>
...
"><div class="col-sm-12 col-xs-12 module-action-bar clearfix"><div class="module-action-content clearfix coloredBorderTop"><div class="col-lg-5 col-md-5"><span><?php $_smarty_tpl->tpl_vars["VIEW_HEADER_LABEL"] = new Smarty_variable("LBL_CALENDAR_VIEW", null, 0);?><?php if ($_smarty_tpl->tpl_vars['VIEW']->value==='SharedCalendar'){?><?php $_smarty_tpl->tpl_vars["VIEW_HEADER_LABEL"] = new Smarty_variable("LBL_SHARED_CALENDAR", null, 0);?><?php }?><!--<a href='javascript:void(0)'><h4 class="module-title pull-left"><span style="cursor: default;"> <?php echo strtoupper(vtranslate($_smarty_tpl->tpl_vars['VIEW_HEADER_LABEL']->value,$_smarty_tpl->tpl_vars['MODULE']->value));?>
 </span></h4></a>--><a href='javascript:void(0)'><h4 class="module-title pull-left"><span style="cursor: default;"> My360 Calendar </span></h4></a></span></div><div class="col-lg-7 col-md-7 pull-right"><!--	<div id="appnav" class="navbar-right"><ul class="nav navbar-nav"><?php if ($_smarty_tpl->tpl_vars['IS_CREATE_PERMITTED']->value){?><li><button id="calendarview_basicaction_addevent" type="button"class="btn addButton btn-default module-buttons cursorPointer"onclick='Calendar_Calendar_Js.showCreateEventModal();'><div class="fa fa-plus" aria-hidden="true"></div>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD_EVENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
