<?php /* Smarty version Smarty-3.1.7, created on 2020-01-07 06:10:34
         compiled from "/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Vtiger/RelatedActivities.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10000252335c8b9df731d6b5-26114540%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0fb17c640f39952b41b42346701845c1215c4e08' => 
    array (
      0 => '/home/ubuntu/project/internal/includes/runtime/../../layouts/v7/modules/Vtiger/RelatedActivities.tpl',
      1 => 1578375670,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10000252335c8b9df731d6b5-26114540',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5c8b9df7396a3',
  'variables' => 
  array (
    'MODULE_NAME' => 0,
    'CALENDAR_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_5c8b9df7396a3')) {function content_5c8b9df7396a3($_smarty_tpl) {?>
...
"/><div class='media'><div class='row'><div class='media-left module-icon col-lg-1 col-md-1 col-sm-1 textAlignCenter'><?php if ($_smarty_tpl->tpl_vars['RECORD']->value->get('subject')=='Call'){?><i class='vicon-call'></i><?php }elseif($_smarty_tpl->tpl_vars['RECORD']->value->get('subject')=='Email'){?><i class='fa fa-envelope-o fa-2x'></i><?php }elseif($_smarty_tpl->tpl_vars['RECORD']->value->get('subject')=='Meeting'){?><i class='fa fa-users fa-2x'></i><?php }elseif($_smarty_tpl->tpl_vars['RECORD']->value->get('subject')=='Task'){?><i class='fa fa-clock-o fa-2x'></i><?php }elseif($_smarty_tpl->tpl_vars['RECORD']->value->get('subject')=='Other'){?><i class='fa fa-mobile fa-2x'></i><?php }?><!--<span class='vicon-<?php echo strtolower($_smarty_tpl->tpl_vars['RECORD']->value->get('activitytype'));?>
