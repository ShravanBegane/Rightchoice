<?php /* Smarty version Smarty-3.1.7, created on 2019-03-14 17:14:00
         compiled from "/home/urldiary/my360crm.urldiary.com/includes/runtime/../../layouts/v7/modules/Calendar/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18506110685c6e8a0b806b34-22181337%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0f121fd476ed6f447720d8e5509b3511873a8882' => 
    array (
      0 => '/home/urldiary/my360crm.urldiary.com/includes/runtime/../../layouts/v7/modules/Calendar/QuickCreate.tpl',
      1 => 1552547632,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18506110685c6e8a0b806b34-22181337',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5c6e8a0b8e24c',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
<?php if ($_valid && !is_callable('content_5c6e8a0b8e24c')) {function content_5c6e8a0b8e24c($_smarty_tpl) {?>
<script>
var showValue = function(val){
   
    //document.getElementById('Events_editView_fieldName_subject').value = val;
    document.getElementById('Calendar_editView_fieldName_subject').value = val;
}
</script>
...
<div class="modal-body"><ul class="calender-list-quick-create"><li><button type="button" class="btn btn-default"  onclick="showValue('Call')"><i class="fa fa-phone" aria-hidden="true"></i>  </button></li><li><button type="button" class="btn btn-default" onclick="showValue('Meeting')"><i class="fa fa-users" aria-hidden="true"></i> </button></li><li><button type="button" class="btn btn-default" onclick="showValue('Task')"><i class="fa fa-clock-o" aria-hidden="true"></i> </button></li><li><button type="button" class="btn btn-default" onclick="showValue('Demo Locked In')"><i class="fa fa-lock" aria-hidden="true"></i> </button></li><li><button type="button" class="btn btn-default" onclick="showValue('Email')"><i class="fa fa-envelope-o" aria-hidden="true"></i> </button></li><li><button type="button" class="btn btn-default" onclick="showValue('Mobile Call')"><i class="fa fa-mobile" aria-hidden="true"></i> </button></li></ul><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
--><div class="muted col-sm-3" style="line-height: 67px;left: 20px; padding-right: 7%;"><?php echo vtranslate('Due Date',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</div><!--	<div class="col-sm-5" <?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Calendar'){?>style="margin-top: 4%;"<?php }?>>--><div class="col-sm-9" <?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Calendar'){?>style="margin-top: 4%;padding-lefty:0px;"<?php }?>><?php $_smarty_tpl->tpl_vars["FIELD_MODEL"] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value['due_date'], null, 0);?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
