...
$languageStrings = array(
	...
	// Footer
	'APPTITLE' => 'RightChoice',
	'POWEREDBY'=> 'Powered by RightChoice',
	...
	'Accounts' => 'Business',//Organizations
	'Assets' => 'Assets',
	'Calendar' => 'Calendar',
	'Campaigns' => 'Campaigns',
	...
	'LBL_VTIGER_CRM_HONEST_OPEN_SOURCE' => 'RightChoice On Demand',
	...
	'IMPORT_CONTACTS_GOOGLE_HELP_TEXT' => 'We can bring contacts from Google and <br> you can also enable bi-direction sync to keep our<br>
									RightChoice contacts and Google contacts(in selected group) updated.<br>
	...
	'LBL_SOCIAL_LINKED' => 'Your RightChoice is now linked to',
	'LBL_ENTER_KEYWORDS_HELP'=>'RightChoice will scan twitter and find messages with these words',
	...
	'LBL_LOOKUP_SEARCH_MODE_INFO'=>'Ex: In Contact creation form, when you enter text in the business name box this setting will control what fields in Business are to be searched',
	...
	'LBL_ROLLUP_COMMENTS_INFO' => "If Roll up is set to 'On' comments on related records will be shown. 
								 For example, if you are viewing comments on an Business record, comments added to related Contacts, Opportunities, Tickets, ..etc would also be displayed.",
	...
	'LBL_SHARED_TAGS_ACCESS'=>'Shared tags are accessible by all users in RightChoice',
	...
	'LBL_TIME' => 'Time',
	'LBL_SKIPPED' => 'Skipped',
	'vt_create' => 'Records Created in RightChoice',
	'vt_update' => 'Records Updated in RightChoice',
	'vt_delete' => 'Records Deleted in RightChoice',
	'vt_skip' => 'Records skipped in RightChoice',
	...
	'LBL_MARKETING' => 'My360Cafe',
	'LBL_SALES' => 'My360Capture',
	...
	. 'For example, if a new support email comes from john@company.com, it would be linked to Business that has '
	...
	'LBL_VTIGER_NOTIFICATION' => 'Message from : RightChoice System Notifications',
...
$jsLanguageStrings = array(
	...
	'JS_DUPLICTAE_CREATION_CONFIRMATION' => 'Business Name already Exists.Do you want to create a duplicate record?',
	...
	'JS_VCF_FILE_IMPORT_WARNING' => 'You have selected a VCF file. Only Contacts can be imported from VCF file. To import this file, please initiate import from Contacts module',
	...
	'JS_PLEASE_SELECT_AN_ACCOUNT_TO_COPY_ADDRESS' => 'Please select an Business to copy address',
	'JS_PLEASE_SELECT_AN_CONTACT_TO_COPY_ADDRESS' => 'Please select a Contact to copy address',
	'JS_SELECTED_ACCOUNT_DOES_NOT_HAVE_AN_ADDRESS' => 'Selected Business does not contain address to copy',
	...
	'JS_CURRENCY_TOOLTIP_CONTENT_MESSAGE' => 'For importing Currency values in Line items, RightChoice will use this setting to identify the currency. Any currency values outside the line items tables, are assumed to be in User\'s preferred currency (selected in \'My Preferences\')',
	'LBL_CANT_SELECT_CONTACT_FROM_LEADS' => 'Cannot select related Contact for Leads',
	...
	'JS_SUITABLE_VTIGER_FIELD_NOT_AVAILABLE_FOR_MAPPING' => 'Suitable RightChoice field not available for mapping',
	...
	'JS_MORE_VTIGER' => 'There are more records to be synchronized in RightChoice',
	...
	'JS_CREATE_TASK' => 'Create Activity',
	...
	'JS_LBL_HELP' => 'Help',
	'JS_LBL_HELP_TEXT' => 'Click on Help button to find Guides and FAQs, and use the Help menu dropdown to get assistance from RightChoice support team',
	...
	'JS_TAB_REORDERED' =>'Reordered',
	//Convert Lead
	'JS_CONVERT_LEAD_ERROR' => 'You have to enable either Business or Contacts module to convert the Lead.',
