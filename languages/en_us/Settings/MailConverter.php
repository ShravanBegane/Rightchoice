...
$languageStrings = array(
	...
	'CREATE_Accounts_SUBJECT' => 'Create Business',
	'LBL_ACTIONS' => 'Actions',
	...
	'LBL_MAILCONVERTER_DESCRIPTION' => "Mail Converter enables you to configure your mailbox to scan your emails and create appropriate entities in My360CRM.<br />You'll also need to define rules to specify what actions should be performed on your emails.<br />Your emails are scanned automatically, unless you've disabled Mail Scanner task in Scheduler. <br /><br /><br />",
	...
	'LINK_Accounts_FROM' => 'Add to Business [FROM]',
	'LINK_Accounts_TO' => 'Add to Business [TO]',
    ...
    'LBL_EMAIL_BODY_INFO' => 'Copy text from a sample email to be scanned into the below box. My360CRM will try to locate values and help you map to CRM fields.',
