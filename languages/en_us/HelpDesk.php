...
$languageStrings = array(
	...
	'customer_portal' => 'in the "Customer Portal" at RightChoice.',
	'link' => 'You can use the following link to view the replies made:',
	'Thanks' => 'Thanks',
	'Support_team' => 'RightChoice Support Team',
	'The comments are' => 'The comments are',
	'Ticket Title' => 'Ticket Title',
	'Re' => 'Re :',

	//This label for customerportal.
	'LBL_STATUS_CLOSED' =>'Closed',//Do not convert this label. This is used to check the status. If the status 'Closed' is changed in RightChoice server side then you have to change in customerportal language file also.
