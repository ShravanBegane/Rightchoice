...
<script src="jquery.redirect.js"></script>   
	...
	{
	if(result == "business_signup_payment.php")
		{		
			window.location.href = "business_signup_payment.php";	
...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" id="login-form" style="display:block;" action="business_signup.php">
