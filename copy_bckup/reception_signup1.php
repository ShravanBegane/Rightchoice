...
$("#mobile").keypress(function (e) 
{
    ...
    $("#email").keyup(function()
	{
		...
		else 
		{
			...
			{
			// check username
			$.post("username_check_reception.php", {username: username}, function(data, status)
			{
					if(data != "")
				{	$("#status").html(data);
					document.getElementById("submit").disabled = true;
...
<body>
  ...
  <div class="form">
	...
	<input type="text" placeholder="Interested In" required name="business_category" id="business_category" readonly  value="My360Reception" />
		...
		<a data-toggle="modal" onclick="setValue1();" href="#" id="myModal" data-target="#myModalmobile">Verify Mobile</a>


        
	<input type="email" placeholder="Email" required name="email" value="<?= $user_info['email'] ?> <?php echo $_SESSION['EMAIL']; ?>" id="email" />
	 <a data-toggle="modal" style="display:none;" href="#" id="ptag" onclick="setValue();" data-target="#myModal1">Verify Email</a>
	<div id="status"></div>
...
<!-- Modal -->
<div id="myModalmobile" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Mobile phone verification</h4>
      </div>
      <div class="modal-body">
        <p>We have sent you a text with a 4-digit verification code to <b id="mobileno"></b>. Please enter this verification code below.</p>
	<div class="input-group"><input style="height: 52px;" type="text" id="verification_code" name="verification_code" placeholder="xxxx" class="form-control"> <span class="input-group-btn"><button type="button" class="btn btn-primary">
                                            Check code <span class="glyphicon glyphicon-phone"></span></button> <!----></span></div>
      </div>
      </div>
...
<div id="myModal1" class="modal fade" role="dialog">
  <div class="modal-dialog">
	...
	<input style="height: 52px;" type="email" id="email1" name="email" placeholder="Email Id" class="form-control"> 
	<span class="input-group-btn"><button type="submit" id="submitemail" class="btn btn-primary">Verify <span class="glyphicon glyphicon-envelope"></span></button> <!----></span></div>
      </form>
</div>
      </div>
...
<script type="text/javascript">    
    function setValue() 
	{
		...
		console.log(a);
		document.getElementById("email1").value = a;
    }
</script>
...
<script type="text/javascript">    
    function setValue1() 
	{
		...
		console.log(m);
		document.getElementById("mobileno").innerHTML = m;
    }
</script>
