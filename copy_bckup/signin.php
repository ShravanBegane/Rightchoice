...
<?php } ?>
    ...
    <form class="login-form" action="login1.php" method="post">
        <input type="email"   placeholder="Email" required type="text" name="user_name" id="user_name">
       ...
       <button id="submit" type="submit" name="form_submitted" class="btn btn-success login_comx1">Log In</button><br/><br/>
        <button id="button" type="button" name="submit" class="login_comx2" value="New to RightChoice? Create an account"><a href="https://my360crm.com/pricing/" style="color:#000;text-decoration:none;">New to RightChoice? Create an account</a></button>
...
.login-page {
   /*background: url(http://internal.my360crm.com/copy/login_bg1.jpg);*/
  width: 350px;
  padding: 1% 0 0;
  margin: auto;
}
