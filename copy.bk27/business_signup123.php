...
?>
    ...
    <form class="login-form" id="login-form" style="display:block;" action="business_signup123.php">
...
if(firstname=='')
    ...
    $.ajax({
    type: "POST",
    url: "business_copy_db_paid123.php",
    data: dataString,
    cache: false,
    beforeSend: function()
    {
    ...
    success: function(result)
	{
		...
		if(result == "business_signup_payment123.php")
		{		
			window.location.href = "business_signup_payment123.php";	
