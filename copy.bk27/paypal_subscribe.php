<head>
  <title>Subscriber Payment</title>
  <meta charset="utf-8">
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-6">
										<!-----------------------------------One time payment form------------------------------------>
											<form name="myForm1" id="subscriptionform" action="https://www.paypal.com/cgi-bin/webscr" method="post" novalidate="novalidate" target="print_popup"  onsubmit="window.open('about:blank','print_popup','width=650,height=500');">	  	        
											<div>
												<div>
											...
											<div>
												<div>
													<select name="currency_code" id="currency" class="currency" required />
														<option value="" selected="true" disabled="disabled" style="">Select Plan</option>
														<option value="plans">Monthly</option>
											...
											<div><br>
												...
												<input type="submit" name="Submit" value="Subscribe" id="paynw-btn" class="pay7"><br>
											</div>				
										</form>
