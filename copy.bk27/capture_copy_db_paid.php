...
$url = $service_url."?operation=getchallenge&username=".$username."&password=".$password;
			...
			$folder_path = "website/capture/".$plan."/";
			$path = '../'.$folder_path.$companynamerename.'/';
			//echo $folder_path;echo "<br/>";
		...
		if($plan == "Free")
		{
			...
			$DB_USER = "comx";
			$DB_PASS = "password";
			$DB_DST_NAME = "my360crm_capture_".$plan."_".$renamed_company_name;
						...
						$userId = $clima->result->userId;
							...
							else
							{
								echo "<div class='alert alert-success' id='success_message'>
										  <strong>Success!</strong> Your request for ".$business_category." - Capture CRM trial has been received, We will set up your free trial shortly . 
									  </div>
		...
		else
		{
				...
				if($clima->success == 1)
				{
						...
						$userId = $clima->result->userId;
							...
							{
								echo 'capture_signup_payment.php';
