...
<h3 style="text-align:center;">Payment Method </h3><br>
       <div id="welcomeDiv" class="answer_list" >
			<ul class="nav nav-pills nav-payment">
				...
				<li><?php if($_SESSION["plan"] == 'Small'){ ?>
	<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                    <input type="hidden" name="cmd" value="_s-xclick">
                    <input type="hidden" name="hosted_button_id" value="CKFNBJ8PS2QWL">
					<input type="hidden" name="return"  value="success.php" />
					<input  type="hidden"  name="cancel_return"  value="cancel.php" />	
                   <input type="submit" value="Paypal" border="0" name="submit" id="Small"  alt="PayPal – The safer, easier way to pay online!">
                    <img alt="" border="0" src="https://www.paypalobjects.com/en_AU/i/scr/pixel.gif" width="1" height="1">
         </form>
<!--	
<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="Y7728439JCT64">
<input type="submit" value="Paypal" border="0" name="submit" id="Small"  alt="PayPal – The safer, easier way to pay online!">
...
<?php } else if($_SESSION["plan"] == 'Medium'){ ?>
	<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                    <input type="hidden" name="cmd" value="_s-xclick">
                    <input type="hidden" name="hosted_button_id" value="8VH7GDQXKP45Q">
			<input type="hidden" name="return"  value="success.php" />
		    	<input  type="hidden"  name="cancel_return"  value="cancel.php" />	
                   <input type="submit" value="Paypal" border="0" name="submit" id="Medium"  alt="PayPal – The safer, easier way to pay online!">
                    <img alt="" border="0" src="https://www.paypalobjects.com/en_AU/i/scr/pixel.gif" width="1" height="1">
        </form>	
<?php } else if($_SESSION["plan"] == 'Large'){ ?>
	<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                    <input type="hidden" name="cmd" value="_s-xclick">
                    <input type="hidden" name="hosted_button_id" value="V3A3D7BENFPUE">
			<input type="hidden" name="return"  value="success.php" />
		    	<input  type="hidden"  name="cancel_return"  value="cancel.php" />
                    <input type="submit" value="Paypal" border="0" name="submit" id="Large"  alt="PayPal – The safer, easier way to pay online!">
                    <img alt="" border="0" src="https://www.paypalobjects.com/en_AU/i/scr/pixel.gif" width="1" height="1">
        </form>
<?php }  ?></li>
								</ul>
...
.login-page {
   background: url(https://internal.my360crm.com/copy/login_bg2.jpg);
  width: 360px;
  padding: 8% 0 0;
  margin: auto;
}
