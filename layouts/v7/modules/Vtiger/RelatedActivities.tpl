...
{if $RECORD->get('subject') eq 'Call'}
<i class='vicon-call'></i>
{else if $RECORD->get('subject') eq 'Email'}
<i class='fa fa-envelope-o fa-2x'></i>
{else if $RECORD->get('subject') eq 'Meeting'}
<i class='fa fa-users fa-2x'></i>
{else if $RECORD->get('subject') eq 'Task'}
<i class='fa fa-clock-o fa-2x'></i>
{else if $RECORD->get('subject') eq 'Other'}
