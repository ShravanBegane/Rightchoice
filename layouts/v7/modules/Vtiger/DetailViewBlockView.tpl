...
{strip}
	...
	{foreach key=BLOCK_LABEL_KEY item=FIELD_MODEL_LIST from=$RECORD_STRUCTURE}
		...
		<div class="block block_{$MODULE_NAME}_{$BLOCK_LABEL_KEY}"  {php} $block_id = {$BLOCK_LIST[$BLOCK_LABEL_KEY]->get('id')};  if($_GET['tab_label'] == "Business Details"){    if($block_id == '126' || $block_id == '127' || $block_id == '128' || $block_id == '129'){  echo 'style="display:none;"' ;  } } elseif($_GET['tab_label'] == "Business Modules"){ if($block_id == '9' || $block_id == '125' || $block_id == '11' || $block_id == '12'){  echo 'style="display:none;"' ;  } } {/php}   data-block="{$BLOCK_LABEL_KEY}" data-blockid="{$BLOCK_LIST[$BLOCK_LABEL_KEY]->get('id')}">{assign var=IS_HIDDEN value=$BLOCK->isHidden()}
