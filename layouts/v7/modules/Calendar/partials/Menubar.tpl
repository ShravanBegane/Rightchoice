...
<div id="modules-menu" class="modules-menu">
	...
	{foreach item=SIDE_BAR_LINK from=$QUICK_LINKS['SIDEBARLINK']}
			...
			{if $SIDE_BAR_LINK->get('linklabel') eq 'LBL_CALENDAR_VIEW'}
				...
				{assign var=VIEW_ICON_CLASS value="fa fa-calendar"}
			...
			{/if}
			<li class="module-qtip {vtranslate($SIDE_BAR_LINK->get('linklabel'),'Calendar')} {if $CURRENT_LINK_NAME eq $CURRENT_VIEW}active{/if}" title="{vtranslate($SIDE_BAR_LINK->get('linklabel'),'Calendar')}">
