	...
	{if $USER_MODEL->isAdminUser()}
		...
		<div class="settingsgroup">
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
							...
							<div id="{$BLOCK_NAME}_accordion" class="app-nav" role="tab">
								<div class="app-settings-accordion">
									<div class="settingsgroup-accordion">
										<a data-toggle="collapse" data-parent="#accordion" class='collapsed {$BLOCK_NAME}' href="#{$BLOCK_NAME}">
							...
							<div id="{$BLOCK_NAME}" class="panel-collapse collapse ulBlock {if $ACTIVE_BLOCK['block'] eq $BLOCK_NAME} in {/if}">
								<ul class="list-group widgetContainer">
									{foreach item=MENUITEM from=$BLOCK_MENU_ITEMS}
										...
										<li><a data-name="LBL_MAIL_SCANNER" href="index.php?parent=Settings&amp;module=MailConverter&amp;view=List&amp;block=4&amp;fieldid=23" class="menuItemLabel  ui-draggable ui-draggable-handle">Mail Converter
                                            <img id="23_menuItem" data-id="23" class="pinUnpinShortCut cursorPointer pull-right" data-actionurl="index.php?module=Vtiger&amp;parent=Settings&amp;action=Basic&amp;mode=updateFieldPinnedStatus&amp;fieldid=23" data-pintitle="pin" data-unpintitle="Unpin" data-pinimageurl="layouts/v7/skins/images/pin.png" data-unpinimageurl="layouts/v7/skins/images/unpin.png" title="pin" src="layouts/v7/skins/images/pin.png" data-action="pin">
                                            </a>
                                        </li>
                                       <li><a data-name="Mail" href="index.php?module=MailManager&view=List" class="menuItemLabel  ui-draggable ui-draggable-handle">Mail Settings</a>
                                       </li>
								        <li><a data-name="Email Templates"  href="index.php?module=EmailTemplates&view=List&app=TOOLS" class="menuItemLabel  ui-draggable ui-draggable-handle">Email Templates</a>
								        </li>
				...
				{/foreach}
				<!--<div class="settingsgroup-panel panel panel-default instaSearch">
				<div class="app-settings-accordion"><div class="settingsgroup-accordion">
				            <a  href="index.php?module=Calendar&view=Export">
				                <i class="indicator fa fa-chevron-right "></i>&nbsp;<span>Export</span>
				                <a  href="index.php?module=Leads&view=Import">
				                <i class="indicator fa fa-chevron-right "></i>&nbsp;<span>Import</span>
				                </a>
				                </div>
				                </div>
				                </div>-->
