...
$("#mobile").keypress(function (e) 
{
    ...
    if(firstname==''|| lastname==''|| business_category=='' || plan=='' || password=='' || mobile=='' || company_name=='' || email=='')
    {
...
<body>
  ...
  <div class="form">
    ...
    <form class="login-form" id="login-form" style="display:block;" action="signup.php">
