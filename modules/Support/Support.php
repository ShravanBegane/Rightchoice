...
class Support extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_support';
	var $table_index= 'supportid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_supportcf', 'supportid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_support', 'vtiger_supportcf');
	...
	var $related_tables = Array( 
					'vtiger_supportcf' => Array('supportid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_support'   => 'supportid',
	    'vtiger_supportcf' => 'supportid');
	...
	var $list_fields = Array (
		...
		'Support No' => Array('support', 'supportno'),
/*'Support No'=> Array('support', 'supportno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Support No' => 'supportno',
/*'Support No'=> 'supportno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'supportno';
...
/*'Support No'=> 'supportno',*/
	...
	var $popup_fields = Array ('supportno');

	// For Alphabetical search
	var $def_basicsearch_col = 'supportno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'supportno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('supportno','assigned_user_id');

	var $default_order_by = 'supportno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Support::checkWebServiceEntry();
			Support::createUserFieldTable($moduleName);
			Support::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Support'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Support','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
