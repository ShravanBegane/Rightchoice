...
<head>
 ...
 <section>
     <div class="container-fluid pricing2">
         <div class="row price1">
             <h2 class="capture3">RightCRM</h2>
         </div>
         <div class="row">
             <div class="col-md-1">
             ...
             <div class="col-md-2 bg1">
                 ...
                 <h4 class="medium1">$37 / month</h4>
                 <p>3 Users, Additional + $2</p>
                <p>Unlimited</p>
                <p>Unlimited</p>
                <p>15GB</p>
                <!----------------------------------New------------------------------------------------>
             ...
             <div class="col-md-2 bg2">
                 ...
                 <h4 class="large1">$57 / month</h4>
                 <p>5 Users, Additional + $2</p>
                <p>Unlimited</p>
                <p>Unlimited</p>
                <p>25GB</p>
                <!-------------------------------------------New---------------------------------------->
 ...
 <section>
     <div class="container-fluid" style="width:86%;">
         <div class="row price1">
             <h2 class="capture3">RightBusiness</h2>
 ...
 <style>
    ...
    box-shadow: 2px 1px 2px 0px dimgrey;
    }
    .free_btn
    {
    background: #09140A;
